...
class Window(QWidget):
    ...
    def _imagesTab(self):
        ...
        self.vm_picture = self.lineEdit(
            layout, "Output Picture", "$HIP/render/$HIPNAME.$OS.$F4.exr"
        )
    ...
    def _renderingTab(self):
        ...
        self.vm_renderengine = self.orderedMenu(
            layout, "Render Engine", RENDERENGINE, 3
        )
    ...
    def __limitsTab(self):
        ...
        self.vm_opacitylimit = self.floatSlider(
            layout, "Opacity Limit", 0.995, 0.0, 1.0
        )
    ...
    def createDict(self):
        output = {
            ...
            "image": {
                ...
                "output": {"vm_pfilter": self.vm_pfilter.text()},
            },
            "rendering": {
                ...
                "sampling": {
                    "vm_samples": [self.vm_samplesx.value(), self.vm_samplesy.value()]
                },
                "limits": {
